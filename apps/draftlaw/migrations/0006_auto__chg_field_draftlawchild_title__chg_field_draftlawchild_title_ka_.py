...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DraftLawChild.title'
        db.alter_column('draftlaw_draftlawchild', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DraftLawChild.title_ka'
        db.alter_column('draftlaw_draftlawchild', 'title_ka', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DraftLawChild.title_en'
        db.alter_column('draftlaw_draftlawchild', 'title_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DraftLaw.author_en'
        db.alter_column('draftlaw_draftlaw', 'author_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DraftLaw.title_en'
        db.alter_column('draftlaw_draftlaw', 'title_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DraftLaw.title'
        db.alter_column('draftlaw_draftlaw', 'title', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DraftLaw.initiator_en'
        db.alter_column('draftlaw_draftlaw', 'initiator_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DraftLaw.initiator'
        db.alter_column('draftlaw_draftlaw', 'initiator', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DraftLaw.title_ka'
        db.alter_column('draftlaw_draftlaw', 'title_ka', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DraftLaw.author'
        db.alter_column('draftlaw_draftlaw', 'author', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DraftLaw.author_ka'
        db.alter_column('draftlaw_draftlaw', 'author_ka', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DraftLaw.initiator_ka'
        db.alter_column('draftlaw_draftlaw', 'initiator_ka', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'DraftLawChild.title'
        db.alter_column('draftlaw_draftlawchild', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DraftLawChild.title_ka'
        db.alter_column('draftlaw_draftlawchild', 'title_ka', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLawChild.title_en'
        db.alter_column('draftlaw_draftlawchild', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLaw.author_en'
        db.alter_column('draftlaw_draftlaw', 'author_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLaw.title_en'
        db.alter_column('draftlaw_draftlaw', 'title_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLaw.title'
        db.alter_column('draftlaw_draftlaw', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DraftLaw.initiator_en'
        db.alter_column('draftlaw_draftlaw', 'initiator_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLaw.initiator'
        db.alter_column('draftlaw_draftlaw', 'initiator', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DraftLaw.title_ka'
        db.alter_column('draftlaw_draftlaw', 'title_ka', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLaw.author'
        db.alter_column('draftlaw_draftlaw', 'author', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DraftLaw.author_ka'
        db.alter_column('draftlaw_draftlaw', 'author_ka', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLaw.initiator_ka'
        db.alter_column('draftlaw_draftlaw', 'initiator_ka', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DraftLaw.sms_ka'
        db.delete_column('draftlaw_draftlaw', 'sms_ka')

        # Deleting field 'DraftLaw.sms_en'
        db.delete_column('draftlaw_draftlaw', 'sms_en')


    def backwards(self, orm):
        # Adding field 'DraftLaw.sms_ka'
        db.add_column('draftlaw_draftlaw', 'sms_ka',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'DraftLaw.sms_en'
        db.add_column('draftlaw_draftlaw', 'sms_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

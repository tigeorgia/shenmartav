...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DraftLaw.full_text_url'
        db.alter_column('draftlaw_draftlaw', 'full_text_url', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'DraftLaw.enacted_text_url'
        db.alter_column('draftlaw_draftlaw', 'enacted_text_url', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'DraftLaw.full_text_url'
        db.alter_column('draftlaw_draftlaw', 'full_text_url', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'DraftLaw.enacted_text_url'
        db.alter_column('draftlaw_draftlaw', 'enacted_text_url', self.gf('django.db.models.fields.CharField')(max_length=255))

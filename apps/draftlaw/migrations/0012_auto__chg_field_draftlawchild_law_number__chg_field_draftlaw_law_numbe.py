...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DraftLawChild.law_number'
        db.alter_column('draftlaw_draftlawchild', 'law_number', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'DraftLaw.law_number'
        db.alter_column('draftlaw_draftlaw', 'law_number', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):

        # Changing field 'DraftLawChild.law_number'
        db.alter_column('draftlaw_draftlawchild', 'law_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'DraftLaw.law_number'
        db.alter_column('draftlaw_draftlaw', 'law_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    models = {
        ...
        'draftlaw.draftlaw': {
            ...
            'enacted_text_url': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            ...
            'full_text_url': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'law_number': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeclarationSecurity.quantity_en'
        db.add_column('incomedeclaration_declarationsecurity', 'quantity_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DeclarationSecurity.quantity_ka'
        db.add_column('incomedeclaration_declarationsecurity', 'quantity_ka',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeclarationSecurity.quantity_en'
        db.delete_column('incomedeclaration_declarationsecurity', 'quantity_en')

        # Deleting field 'DeclarationSecurity.quantity_ka'
        db.delete_column('incomedeclaration_declarationsecurity', 'quantity_ka')

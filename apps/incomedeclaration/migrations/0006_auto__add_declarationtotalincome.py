...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeclarationTotalIncome'
        db.create_table('incomedeclaration_declarationtotalincome', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('representative', self.gf('django.db.models.fields.related.ForeignKey')(related_name='declarationtotalincome', null=True, to=orm['representative.Representative'])),
            ('ad_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('ad_submission_date', self.gf('django.db.models.fields.DateField')()),
            ('ad_entrepreunerial_income', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('ad_paid_work_income', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal('incomedeclaration', ['DeclarationTotalIncome'])

    def backwards(self, orm):
        # Deleting model 'DeclarationTotalIncome'
        db.delete_table('incomedeclaration_declarationtotalincome')
    ...
    models = {
        ...
        'incomedeclaration.declarationtotalincome': {
            ...
            'ad_entrepreunerial_income': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),

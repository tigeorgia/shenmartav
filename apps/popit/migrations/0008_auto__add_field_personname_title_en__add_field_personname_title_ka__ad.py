...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonName.title_en'
        db.add_column('popit_personname', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonName.title_ka'
        db.add_column('popit_personname', 'title_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonName.name_en'
        db.add_column('popit_personname', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PersonName.name_ka'
        db.add_column('popit_personname', 'name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrganisationName.name_en'
        db.add_column('popit_organisationname', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrganisationName.name_ka'
        db.add_column('popit_organisationname', 'name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.title_en'
        db.add_column('popit_position', 'title_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.title_ka'
        db.add_column('popit_position', 'title_ka',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.place_en'
        db.add_column('popit_position', 'place_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.place_ka'
        db.add_column('popit_position', 'place_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.note_en'
        db.add_column('popit_position', 'note_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Position.note_ka'
        db.add_column('popit_position', 'note_ka',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.description_en'
        db.add_column('popit_person', 'description_en',
                      self.gf('markitup.fields.MarkupField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.description_ka'
        db.add_column('popit_person', 'description_ka',
                      self.gf('markitup.fields.MarkupField')(default='', null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'PersonName.title_en'
        db.delete_column('popit_personname', 'title_en')

        # Deleting field 'PersonName.title_ka'
        db.delete_column('popit_personname', 'title_ka')

        # Deleting field 'PersonName.name_en'
        db.delete_column('popit_personname', 'name_en')

        # Deleting field 'PersonName.name_ka'
        db.delete_column('popit_personname', 'name_ka')

        # Deleting field 'OrganisationName.name_en'
        db.delete_column('popit_organisationname', 'name_en')

        # Deleting field 'OrganisationName.name_ka'
        db.delete_column('popit_organisationname', 'name_ka')

        # Deleting field 'Position.title_en'
        db.delete_column('popit_position', 'title_en')

        # Deleting field 'Position.title_ka'
        db.delete_column('popit_position', 'title_ka')

        # Deleting field 'Position.place_en'
        db.delete_column('popit_position', 'place_en')

        # Deleting field 'Position.place_ka'
        db.delete_column('popit_position', 'place_ka')

        # Deleting field 'Position.note_en'
        db.delete_column('popit_position', 'note_en')

        # Deleting field 'Position.note_ka'
        db.delete_column('popit_position', 'note_ka')

        # Deleting field 'Person.description_en'
        db.delete_column('popit_person', 'description_en')

        # Deleting field 'Person.description_ka'
        db.delete_column('popit_person', 'description_ka')
    ...
    models = {
        ...
        'popit.person': {
            ...
            'description_en': ('markitup.fields.MarkupField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'description_ka': ('markitup.fields.MarkupField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

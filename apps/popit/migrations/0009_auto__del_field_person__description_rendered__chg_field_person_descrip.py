...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Person._description_rendered'
        db.delete_column('popit_person', '_description_rendered')


        # Changing field 'Person.description'
        db.alter_column('popit_person', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Person.description_ka'
        db.alter_column('popit_person', 'description_ka', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Person.description_en'
        db.alter_column('popit_person', 'description_en', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Adding field 'Person._description_rendered'
        db.add_column('popit_person', '_description_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Person.description'
        db.alter_column('popit_person', 'description', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))

        # Changing field 'Person.description_ka'
        db.alter_column('popit_person', 'description_ka', self.gf('markitup.fields.MarkupField')(null=True))

        # Changing field 'Person.description_en'
        db.alter_column('popit_person', 'description_en', self.gf('markitup.fields.MarkupField')(null=True))

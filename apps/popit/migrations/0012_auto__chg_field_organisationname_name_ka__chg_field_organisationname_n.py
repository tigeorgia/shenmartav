...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrganisationName.name_ka'
        db.alter_column('popit_organisationname', 'name_ka', self.gf('django.db.models.fields.CharField')(default='', max_length=300))

        # Changing field 'OrganisationName.name_en'
        db.alter_column('popit_organisationname', 'name_en', self.gf('django.db.models.fields.CharField')(default='', max_length=300))
    def backwards(self, orm):

        # Changing field 'OrganisationName.name_ka'
        db.alter_column('popit_organisationname', 'name_ka', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'OrganisationName.name_en'
        db.alter_column('popit_organisationname', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
    models = {
        'popit.codetype': {
        ...
        'popit.organisationname': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'name_ka': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),

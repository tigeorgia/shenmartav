...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('question_question', (
            ...
            ('representative', self.gf('django.db.models.fields.related.ForeignKey')(related_name='questions', to=orm['representative.Representative'])),
            ('answer', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('question', ['Question'])

        # Adding model 'QuestionPluginConf'
        db.create_table('cmsplugin_questionpluginconf', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=u'Questions', max_length=32)),
        ))
        db.send_create_signal('question', ['QuestionPluginConf'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'QuestionPluginConf'
        db.delete_table('cmsplugin_questionpluginconf')

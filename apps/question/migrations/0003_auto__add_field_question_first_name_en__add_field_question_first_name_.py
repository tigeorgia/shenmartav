...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.first_name_en'
        db.add_column('question_question', 'first_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.first_name_ka'
        db.add_column('question_question', 'first_name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.last_name_en'
        db.add_column('question_question', 'last_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Question.last_name_ka'
        db.add_column('question_question', 'last_name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.first_name_en'
        db.delete_column('question_question', 'first_name_en')

        # Deleting field 'Question.first_name_ka'
        db.delete_column('question_question', 'first_name_ka')

        # Deleting field 'Question.last_name_en'
        db.delete_column('question_question', 'last_name_en')

        # Deleting field 'Question.last_name_ka'
        db.delete_column('question_question', 'last_name_ka')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Representative.other_income'
        db.add_column('representative_representative', 'other_income',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Representative.other_income'
        db.delete_column('representative_representative', 'other_income')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Party'
        db.create_table('representative_party', (
            ('organisation_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popit.Organisation'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('representative', ['Party'])


    def backwards(self, orm):
        # Deleting model 'Party'
        db.delete_table('representative_party')

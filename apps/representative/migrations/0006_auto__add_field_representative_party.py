...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('representative_representative', 'party',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='representatives', null=True, to=orm['representative.Party']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Representative.party'
        db.delete_column('representative_representative', 'party_id')

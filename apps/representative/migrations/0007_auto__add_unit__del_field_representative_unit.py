...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Unit'
        db.create_table('representative_unit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('short', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('representative', ['Unit'])

        # Adding M2M table for field parties on 'Unit'
        db.create_table('representative_unit_parties', (
        ...
        db.create_unique('representative_unit_parties', ['unit_id', 'party_id'])

        # Deleting field 'Representative.unit'
        db.delete_column('representative_representative', 'unit')


    def backwards(self, orm):
        # Deleting model 'Unit'
        db.delete_table('representative_unit')

        # Removing M2M table for field parties on 'Unit'
        db.delete_table('representative_unit_parties')

        # Adding field 'Representative.unit'
        db.add_column('representative_representative', 'unit',

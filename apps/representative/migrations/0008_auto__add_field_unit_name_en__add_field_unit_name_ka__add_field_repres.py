...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.name_en'
        db.add_column('representative_unit', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.name_ka'
        db.add_column('representative_unit', 'name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Representative.unit'
        db.add_column('representative_representative', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='representatives', null=True, to=orm['representative.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.name_en'
        db.delete_column('representative_unit', 'name_en')

        # Deleting field 'Unit.name_ka'
        db.delete_column('representative_unit', 'name_ka')

        # Deleting field 'Representative.unit'
        db.delete_column('representative_representative', 'unit_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Representative.gender'
        db.add_column('representative_representative', 'gender',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Representative.gender'
        db.delete_column('representative_representative', 'gender')

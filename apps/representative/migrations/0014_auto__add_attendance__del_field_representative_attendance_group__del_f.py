...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('representative_attendance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attended', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('percentage_attended', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('absent', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('percentage_absent', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('group', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('representative', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance', to=orm['representative.Representative'])),
        ))
        db.send_create_signal('representative', ['Attendance'])

        # Deleting field 'Representative.attendance_group'
        db.delete_column('representative_representative', 'attendance_group')

        # Deleting field 'Representative.attendance_record'
        db.delete_column('representative_representative', 'attendance_record')


    def backwards(self, orm):
        # Deleting model 'Attendance'
        db.delete_table('representative_attendance')

        # Adding field 'Representative.attendance_group'
        db.add_column('representative_representative', 'attendance_group',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Representative.attendance_record'
        db.add_column('representative_representative', 'attendance_record',

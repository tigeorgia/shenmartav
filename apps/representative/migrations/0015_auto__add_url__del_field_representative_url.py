...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Url'
        db.create_table('representative_url', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('representative', self.gf('django.db.models.fields.related.ForeignKey')(related_name='urls', null=True, to=orm['representative.Representative'])),
            ('label', self.gf('django.db.models.fields.CharField')(default=u'Homepage', max_length=255)),
            ('label_en', self.gf('django.db.models.fields.CharField')(default=u'Homepage', max_length=255, null=True, blank=True)),
            ('label_ka', self.gf('django.db.models.fields.CharField')(default=u'Homepage', max_length=255, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('representative', ['Url'])

        # Deleting field 'Representative.url'
        db.delete_column('representative_representative', 'url')


    def backwards(self, orm):
        # Deleting model 'Url'
        db.delete_table('representative_url')

        # Adding field 'Representative.url'
        db.add_column('representative_representative', 'url',

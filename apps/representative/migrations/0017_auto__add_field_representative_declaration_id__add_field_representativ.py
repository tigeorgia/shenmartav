...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Representative.declaration_id'
        db.add_column('representative_representative', 'declaration_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Representative.submission_date'
        db.add_column('representative_representative', 'submission_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Representative.entrepreneurial_salary'
        db.add_column('representative_representative', 'entrepreneurial_salary',
                      self.gf('django.db.models.fields.FloatField')(default=0, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Representative.declaration_id'
        db.delete_column('representative_representative', 'declaration_id')

        # Deleting field 'Representative.submission_date'
        db.delete_column('representative_representative', 'submission_date')

        # Deleting field 'Representative.entrepreneurial_salary'
        db.delete_column('representative_representative', 'entrepreneurial_salary')

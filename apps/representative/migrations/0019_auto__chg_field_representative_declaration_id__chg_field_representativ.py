...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Representative.declaration_id'
        db.alter_column('representative_representative', 'declaration_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Representative.gender'
        db.alter_column('representative_representative', 'gender', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'Representative.declaration_id'
        db.alter_column('representative_representative', 'declaration_id', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Representative.gender'
        db.alter_column('representative_representative', 'gender', self.gf('django.db.models.fields.IntegerField')())
    models = {
        'popit.organisation': {

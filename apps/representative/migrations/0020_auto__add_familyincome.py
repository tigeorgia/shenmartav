...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FamilyIncome'
        db.create_table('representative_familyincome', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('representative_id', self.gf('django.db.models.fields.related.ForeignKey')(related_name='representative_id', null=True, to=orm['representative.Representative'])),
            ('ad_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('submission_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('html_table', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('representative', ['FamilyIncome'])

    def backwards(self, orm):
        # Deleting model 'FamilyIncome'
        db.delete_table('representative_familyincome')
    ...
    models = {
        ...
        'representative.familyincome': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'representative_id': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'representative_id'", 'null': 'True', 'to': "orm['representative.Representative']"}),

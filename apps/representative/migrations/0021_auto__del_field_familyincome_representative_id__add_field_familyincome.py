...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FamilyIncome.representative_id'
        db.delete_column('representative_familyincome', 'representative_id_id')

        # Adding field 'FamilyIncome.representative'
        db.add_column('representative_familyincome', 'representative',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='representative_id', null=True, to=orm['representative.Representative']),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'FamilyIncome.representative_id'
        db.add_column('representative_familyincome', 'representative_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='representative_id', null=True, to=orm['representative.Representative']),
                      keep_default=False)

        # Deleting field 'FamilyIncome.representative'
        db.delete_column('representative_familyincome', 'representative_id')
    ...
    models = {
        ...
        'representative.familyincome': {
            ...
            'html_table': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'representative': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'representative_id'", 'null': 'True', 'to': "orm['representative.Representative']"}),

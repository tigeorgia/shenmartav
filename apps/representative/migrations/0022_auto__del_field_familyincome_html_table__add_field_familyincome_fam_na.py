...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FamilyIncome.html_table'
        db.delete_column('representative_familyincome', 'html_table')

        # Adding field 'FamilyIncome.fam_name'
        db.add_column('representative_familyincome', 'fam_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FamilyIncome.fam_role'
        db.add_column('representative_familyincome', 'fam_role',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FamilyIncome.fam_gender'
        db.add_column('representative_familyincome', 'fam_gender',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FamilyIncome.fam_date_of_birth'
        db.add_column('representative_familyincome', 'fam_date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FamilyIncome.fam_income'
        db.add_column('representative_familyincome', 'fam_income',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FamilyIncome.fam_cars'
        db.add_column('representative_familyincome', 'fam_cars',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'FamilyIncome.html_table'
        db.add_column('representative_familyincome', 'html_table',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FamilyIncome.fam_name'
        db.delete_column('representative_familyincome', 'fam_name')

        # Deleting field 'FamilyIncome.fam_role'
        db.delete_column('representative_familyincome', 'fam_role')

        # Deleting field 'FamilyIncome.fam_gender'
        db.delete_column('representative_familyincome', 'fam_gender')

        # Deleting field 'FamilyIncome.fam_date_of_birth'
        db.delete_column('representative_familyincome', 'fam_date_of_birth')

        # Deleting field 'FamilyIncome.fam_income'
        db.delete_column('representative_familyincome', 'fam_income')

        # Deleting field 'FamilyIncome.fam_cars'
        db.delete_column('representative_familyincome', 'fam_cars')

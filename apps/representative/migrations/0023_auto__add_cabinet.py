...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table('representative_cabinet')
    ...
    models = {
        ...
        'representative.cabinet': {
            ...
            'parties': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'cabinet'", 'blank': 'True', 'to': "orm['representative.Party']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Faction.name_en'
        db.add_column('representative_faction', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Faction.name_ka'
        db.add_column('representative_faction', 'name_ka',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Faction.name_en'
        db.delete_column('representative_faction', 'name_en')

        # Deleting field 'Faction.name_ka'
        db.delete_column('representative_faction', 'name_ka')

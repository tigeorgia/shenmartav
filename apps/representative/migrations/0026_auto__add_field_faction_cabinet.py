...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Faction.cabinet'
        db.add_column('representative_faction', 'cabinet',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='faction', null=True, to=orm['representative.Cabinet']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Faction.cabinet'
        db.delete_column('representative_faction', 'cabinet_id')

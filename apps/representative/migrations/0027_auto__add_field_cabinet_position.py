...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cabinet.position'
        db.add_column('representative_cabinet', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cabinet.position'
        db.delete_column('representative_cabinet', 'position')

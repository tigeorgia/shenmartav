...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Party.url'
        db.alter_column('representative_party', 'url', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'AdditionalInformation.value'
        db.alter_column('representative_additionalinformation', 'value', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'FamilyIncome.fam_name'
        db.alter_column('representative_familyincome', 'fam_name', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'FamilyIncome.fam_role'
        db.alter_column('representative_familyincome', 'fam_role', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'FamilyIncome.fam_cars'
        db.alter_column('representative_familyincome', 'fam_cars', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'FamilyIncome.fam_gender'
        db.alter_column('representative_familyincome', 'fam_gender', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Faction.short'
        db.alter_column('representative_faction', 'short', self.gf('django.db.models.fields.CharField')(default='', max_length=32))

        # Changing field 'Faction.name'
        db.alter_column('representative_faction', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Representative.electoral_district'
        db.alter_column('representative_representative', 'electoral_district', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Representative.expenses'
        db.alter_column('representative_representative', 'expenses', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Representative.elected'
        db.alter_column('representative_representative', 'elected', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Representative.committee'
        db.alter_column('representative_representative', 'committee', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Representative.education'
        db.alter_column('representative_representative', 'education', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Representative.pob'
        db.alter_column('representative_representative', 'pob', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Representative.contact_address_phone'
        db.alter_column('representative_representative', 'contact_address_phone', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Representative.property_assets'
        db.alter_column('representative_representative', 'property_assets', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Party.url'
        db.alter_column('representative_party', 'url', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'AdditionalInformation.value'
        db.alter_column('representative_additionalinformation', 'value', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FamilyIncome.fam_name'
        db.alter_column('representative_familyincome', 'fam_name', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FamilyIncome.fam_role'
        db.alter_column('representative_familyincome', 'fam_role', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FamilyIncome.fam_cars'
        db.alter_column('representative_familyincome', 'fam_cars', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'FamilyIncome.fam_gender'
        db.alter_column('representative_familyincome', 'fam_gender', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Faction.short'
        db.alter_column('representative_faction', 'short', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Faction.name'
        db.alter_column('representative_faction', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Representative.electoral_district'
        db.alter_column('representative_representative', 'electoral_district', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Representative.expenses'
        db.alter_column('representative_representative', 'expenses', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Representative.elected'
        db.alter_column('representative_representative', 'elected', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Representative.committee'
        db.alter_column('representative_representative', 'committee', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Representative.education'
        db.alter_column('representative_representative', 'education', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Representative.pob'
        db.alter_column('representative_representative', 'pob', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Representative.contact_address_phone'
        db.alter_column('representative_representative', 'contact_address_phone', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Representative.property_assets'
        db.alter_column('representative_representative', 'property_assets', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'representative.familyincome': {
            ...
            'fam_cars': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'fam_date_of_birth': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'fam_gender': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'fam_income': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'fam_name': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            ...
            'fam_role': ('django.db.models.fields.TextField', [], {'blank': 'True'}),

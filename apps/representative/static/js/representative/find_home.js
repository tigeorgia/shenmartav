...
RepresentativeFind = {
    ...
    setInfoDone: function () {
        Base.enable('#representative #mp-info');
    ...
    setupInfo: function () {
        ...
        RepresentativeFind.noneSelected = $('#representative #mp-info #data').html();
    },
    ...
    loadUnit: function (unit) {
        ...
        $('#representative #mp-info #data').html(RepresentativeFind.noneSelected);

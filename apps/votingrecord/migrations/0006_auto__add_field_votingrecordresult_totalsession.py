...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VotingRecordResult.totalsession'
        db.add_column('votingrecord_votingrecordresult', 'totalsession',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VotingRecordResult.totalsession'
        db.delete_column('votingrecord_votingrecordresult', 'totalsession')
